...
id_Ts = 0.1;
id_y = output_pos_rpy(idx_span, 6);
id_u = input_roll_pitch_thrust(idx_span, 3);
id_data = iddata(id_y, id_u, id_Ts);
id_data.InputName = {'pitch_cmd'};
id_data.InputUnit = {'rad/s'};
id_data.OutputName = {'pitch'};
...
pitch_time_constant = -1.0/id_sys.A
pitch_gain = -id_sys.B/id_sys.A
